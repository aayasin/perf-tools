...
if args.GEN:
    ...
    gen_kernel("-i 'aeskeygenassist $0x7e,(%rsp),%xmm0' 'aeskeygenassist $0x7e,%xmm0,%xmm1' 'cmpxchg16b 0x100(%rsp)' 'comisd 0x100(%rsp),%xmm0' 'comisd %xmm0,%xmm1' 'comiss 0x100(%rsp),%xmm0' 'comiss %xmm0,%xmm1' 'cvtsd2si 0x100(%rsp),%r8' 'cvtsd2si %xmm0,%r8d' 'cvtsi2sd %r8d,%xmm0' 'cvtsi2ss %r8d,%xmm0' 'cvtss2si 0x100(%rsp),%r8' 'cvtss2si %xmm0,%r8d' 'cvtss2si %xmm0,%r8' 'cvttsd2si 0x100(%rsp),%r8' 'cvttsd2si 0x100(%rsp),%r8d' 'cvttsd2si %xmm0,%r8' 'cvttsd2si %xmm0,%r8d' 'cvttss2si 0x100(%rsp),%r8' 'cvttss2si 0x100(%rsp),%r8d' -n1 ",'v2ii2v')
