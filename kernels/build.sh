...
$PY ./gen-kernel.py -i 'movl 0x0(%rsp),%ecx' 'test %ecx,%ecx' 'jg Lbl_end' -n 1 --disable_asm > ld-test-jcc-3i.c
$PY ./gen-kernel.py -i 'testq $0x0,0x0(%rsp)' 'jg Lbl_end' -n 1 --disable_asm > ld-test-jcc-2i-imm.c
$PY ./gen-kernel.py -i 'testq %r12,0x0(%rsp)' 'jg Lbl_end' -n 1 -p 'movq $0x0,%r12' --disable_asm > ld-test-jcc-2i-reg.c
fi
